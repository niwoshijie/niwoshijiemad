...
/**
 * Created by LiuShao on 2016/7/25.
 */
public class PullToRefreshLayout extends RelativeLayout implements OnRefreshListener, View.OnTouchListener {
    ...
    private void initView(Context context)
    {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.fab_anim);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(context, R.anim.grow_from_bottom);
        // 添加匀速转动动画
    ...
    public void refreshFinish(int refreshResult)
    {
        ...
        switch (refreshResult)
        {
            case REFRESH_SUCCEED:
                ...
                stateImageView.setBackgroundResource(R.mipmap.g3);
                break;
            case REFRESH_FAIL:
                // 刷新失败
                stateImageView.setVisibility(View.VISIBLE);
                stateTextView.setText("刷新失败");
                stateImageView.setBackgroundResource(R.mipmap.g4);
                break;
            default:
                break;
        }
