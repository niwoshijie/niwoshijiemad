...
public class MyCircleMenu extends ViewGroup {
    ...
    private void measureChild() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child == centerView) {
                makeMeasureSpec = MeasureSpec.makeMeasureSpec((int) (mRadius * radioCenterDimen), childMode);
            } else {
