...
public class RecyclerViewCacheUtil {
    private static RecyclerViewCacheUtil recyclerViewCacheUtil = null;
    ...
    public static RecyclerViewCacheUtil getInstance() {
        if (recyclerViewCacheUtil == null) {
            recyclerViewCacheUtil = new RecyclerViewCacheUtil();
        }
        return recyclerViewCacheUtil;
    }
